...
class GnssPsdsDownloader {
    ...
    private static final String GRAPHENEOS_LONG_TERM_PSDS_1 = "https://google.psds.grapheneos.org/lto2.dat";
    private static final String GRAPHENEOS_LONG_TERM_PSDS_2 = null;
    private static final String GRAPHENEOS_LONG_TERM_PSDS_3 = null;
    private static final String GRAPHENEOS_NORMAL_PSDS = "https://google.psds.grapheneos.org/rto.dat";
    private static final String GRAPHENEOS_REALTIME_PSDS = "https://google.psds.grapheneos.org/rtistatus.dat";
    ...
    private static boolean shouldUseGrapheneOsPsdsServer(Context mContext) {
        final int GRAPHENEOS_PDDS_SERVER_INTVAL = 0;
    ...
    GnssPsdsDownloader(Properties properties, Context context) {
        ...
        if (shouldUseGrapheneOsPsdsServer(context)) {
            longTermPsdsServer1 = GRAPHENEOS_LONG_TERM_PSDS_1;
            longTermPsdsServer2 = GRAPHENEOS_LONG_TERM_PSDS_2;
            longTermPsdsServer3 = GRAPHENEOS_LONG_TERM_PSDS_3;
        } else {
        ...
        if (shouldUseGrapheneOsPsdsServer(context)) {
            normalPsdsServer = GRAPHENEOS_NORMAL_PSDS;
            realtimePsdsServer = GRAPHENEOS_REALTIME_PSDS;
        } else {
